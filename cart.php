                                ...
                                <tbody>
                                    <tr>
                                        <td class="cart_product">
                                            <a href="#"><img class="img-fluid" src="img/item/11.jpg" alt=""></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="cart_product">
                                            <a href="#"><img alt="Product" src="img/item/10.jpg" class="img-fluid"></a>
                                        </td>
                                        <td class="cart_description">
                                            <h5 class="product-name"><a href="#">Ipsums Dolors Untra </a></h5>
                                            <h6><strong><span class="mdi mdi-approval"></span> Available in</strong> - 500 gm</h6>
                                    ...
                                    <tr>
                                        <td class="cart_product">
                                            <a href="#"><img alt="Product" src="img/item/9.jpg" class="img-fluid"></a>
                                        </td>
                                        <td class="cart_description">
                                            <h5 class="product-name"><a href="#">Ipsums Dolors Untra </a></h5>
                                            <h6><strong><span class="mdi mdi-approval"></span> Available in</strong> - 500 gm</h6>
