...
Blog Page
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="blog.php"><i class="mdi mdi-chevron-right" aria-hidden="true"></i> Blog</a>
                            <a class="dropdown-item" href="blog-detail.php"><i class="mdi mdi-chevron-right" aria-hidden="true"></i> Blog Detail</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
More Pages
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <h4 class="mb-5 mt-0">
                        <a class="logo" href="index-2.php"><img src="img/logo-footer.png" alt="Groci"></a>
                    </h4>
    ...
    <script src="vendor/jquery/jquery.min.js" type="4dd4afb74577e2dfe00926d1-text/javascript"></script>
    <script src="vendor/bootstrap/js/bootstrap.bundle.min.js" type="4dd4afb74577e2dfe00926d1-text/javascript"></script>

    <script src="vendor/select2/js/select2.min.js" type="4dd4afb74577e2dfe00926d1-text/javascript"></script>

    <script src="vendor/owl-carousel/owl.carousel.js" type="4dd4afb74577e2dfe00926d1-text/javascript"></script>

    <link href="vendor/datatables/datatables.min.css" rel="stylesheet" />
    <script src="vendor/datatables/datatables.min.js" type="4dd4afb74577e2dfe00926d1-text/javascript"></script>
    <script type="4dd4afb74577e2dfe00926d1-text/javascript">
        $(document).ready(function() {
            $('.datatabel').DataTable();
        });
    </script>

    <script src="js/custom.js" type="4dd4afb74577e2dfe00926d1-text/javascript"></script>
    <script src="cloudflare-static/rocket-loader.min.js" data-cf-settings="4dd4afb74577e2dfe00926d1-|49" defer=""></script>
</body>
